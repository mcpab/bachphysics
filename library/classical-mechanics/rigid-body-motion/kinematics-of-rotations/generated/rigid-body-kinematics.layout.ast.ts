            ...
            children: [
              {
                id: "text-2",
                type: "text",
                body: "A rigid body is defined as a set of points whose relative distances remain fixed."
              },
              {
                id: "text-3",
                type: "text",
                body: "If one point of the body is fixed in space, the remaining motion of the body is purely rotational. "
              }
            ]
          }
        },
            ...
            children: [
              {
                id: "text-4",
                type: "text",
                body: "The kinematical problem is therefore to describe the orientation of the body and how this"
              },
              {
                id: "text-5",
                type: "text",
                body: "orientation changes with time."
              },
              {
                id: "text-6",
                type: "text",
                body: "In this essay we will explore the kinematics of rotations and cover the following topics:"
              }
            ]
          }
        },
                        ...
                        children: {
                          ...
                          children: [
                            ...
                            },
                            {
                              id: "text-7",
                              type: "text",
                              body: "We will review the properties of the transformations that preserve distances and therefore"
                            },
                            {
                              id: "text-8",
                              type: "text",
                              body: "provide the natural mathematical description of rigid rotations."
                            }
                          ]
                        }
                      }
            ...
            children: [
              {
                id: "text-19",
                type: "text",
                body: "A rigid motion preserves the distance between material points. We therefore begin by studying the linear transformations "
              },
              {
                id: "text-20",
                type: "text",
                body: "that preserve distances and scalar products. "
              }
            ]
          }
        },
