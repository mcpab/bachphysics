...
Although this approximation neglects effects such as the Earth's oblateness, it captures the essential
 ...
 mathematical expressions used throughout this essay. \par
...
where $\omega$ is the angular velocity of the Earth equal to $7.29\times10^{-5}\,\text{s}^{-1}$. \par
...
One particularly interesting situation emerge from these expressions, which corresponds to a body at rest in the inertial frame.
In such a situation the body at rest in the inertial frame appears in the rotating frame to move with angular velocity
