...
import Gather from '@/src/katex/Gather';
import Ref from '@/src/katex/Ref';
import Equation from '@/src/katex/Equation';
...
export default function Page() {
  ...
  const mt = (math: string): ReactNode => {
    return <Math math={math} />;
  }
  const eq = (math: string, label?: string) => {
    return <Equation math={math} label={label} />
  }


  const gt = (math: string) => {
    return <Gather math={math} />
  }
  ...
  const mtx = (mode: "none" | 'split' | "matrix" | "pmatrix" | "align" = "matrix", ...args: string[]): string => {
        ...
        <Container>
          <Paper elevation={3} className='p-10 leading-loose space-y-10 text-black justify-center '>
            ...
            <MediaAndText imageSrc='/img/movingframes.jpg' imageSize={60} caption={<div>Fig 1:Photon Emission and Reflection in {mt("F'")}</div>}> The source is located at the origin of {mt("F'")} and the mirror is
              ...
              {eq("\\frac{1}{2}(t'_{0}+t'_{2}) = t'_{1} ", "sync")}
            ...
            <section>
              ...
              {eq("              {\\vb p}\\cdot [ {\\vb v}  (\|{\\vb  c_{up}-\\vb v} \|^{-1}+ \|{\\vb  c_{down}-\\vb v} \|^{-1}) - 2 {\\vb  c_{up}}\|{\\vb  c_{up}-\\vb v} \|^{-1}] + \\beta(\|{\\vb  c_{up}-\\vb v} \|^{-1} - \,\|{\\vb  c_{down}-\\vb v} \|^{-1}) =0", 'eq2')}

            </section>

            <MediaAndText imageSrc='/img/fig1.png' imagePosition='right' imageSize={50} caption="Fig 3:The photon velocities">

              Equation {ref('eq2')}  can be further simplified if we look in detail to the direction of the vectors {mt("{\\vb v}")}, {mt("{\\vb c_{down}}")} and {mt("{\\vb c_{up}}")}.
            ...
            <section>
              ...
              {eq(" {\ p_1} { v} (|{\\vb c_{up}-\\vb v} |^{-1}+ |{\\vb c_{down}-\\vb v} |^{-1}) - 2 { c}(p_1\\cos\\alpha+p_2\\sin\\alpha)|{\\vb c_{up}-\\vb v} |^{-1} +\\beta(|{\\vb c_{up}-\\vb v} |^{-1} - | {\\vb c_{down}-\\vb v} |^{-1}) =0", "eq3")}

              as {mt("p_3")} can be set to zero as it is orthogonal to the plane of {mt("{\\vb c_{down}}")} and {mt("{\\vb v}")}. From {eq("\\cos\\alpha = \\frac{c ^ 2 + v ^ 2 - | {\\vb c_{up}-\\vb v} |^2 }{2 v c} ")} equation {ref('eq3')}  reads

              {eq("p_1 \\frac{c ^ 2}{v} +\\beta +p_2 \\,\\,\\frac{2c\\sin\\alpha |{\\vb c_{up}-v} |}{| {\\vb c_{up}-v} |-|{\\vb c_{down}-v} |} =0\\quad\\forall \\alpha,v ")}

              which has solutions {eq("p_1=-\\beta\\frac{v}{c ^ 2}")}  {eq(" p_2=0")}

              The transformation of time between {mt("F'")} and {mt("F")} becomes then

              {eq("ct' = \\beta \\left(-\\frac{v} {c}{\\vb e}_1\\cdot\\vb x+ct \\right)", "timeT")}
        ...
        <Container>
          <Paper elevation={3} className='p-10 leading-loose space-y-10 text-black justify-center '>
            ...
            <section>
              ...
              {eq(" {\\vb X'} = {\\bf\\Lambda}({\\vb v}) {\\vb X}", "tran11")}
              ...
              {eq(mtx("matrix", "\\lambda_{1, 1} \\ket{\\vb{e}_1,0}\\bra{\\vb{e}_1,0} &+& \\lambda_{1, 2}\\ket{\\vb{e}_1,0}\\bra{\\vb{e}_2,0} &+&\\lambda_{1, 3}\\ket{\\vb{e}_1,0}\\bra{\\vb{e}_3,0}  &+&\\lambda_{1, 4}\\ket{\\vb{e}_1,0}\\bra{\\vb{0},1}",
                ...
                "\\lambda_{4, 1} \\ket{\\vb{0},1}\\bra{\\vb{e}_1,0}   &+& \\lambda_{4, 2}\\ket{\\vb{0},1}\\bra{\\vb{e}_2,0}   &+& \\lambda_{4, 3}\\ket{\\vb{0},1}\\bra{\\vb{e}_3,0}   &+&\\lambda_{4, 4}\\ket{\\vb{0},1}\\bra{\\vb{0},1} "), "generalLambda")}

              where {mt("\\lambda_{i,j}")} are sixteen free parameters. The transformation of time {ref('timeT')} can be utilized to identify some of the  {mt("\\lambda_{i,j}")} but not all of them:
            ...
            <section>
              ...
              but from the transformation of time {ref('timeT')} there are only components along {mt("\\vb e_1")} and time, hence {mt("\\lambda_{2,4}=\\lambda_{3,4}=0")}.
            </section>
            ...
            <section>
              ...
              this results in {mt("\\lambda_{2,1}=\\lambda_{3,1}=0")} to satisfy our assumption. Equation {ref('generalLambda')}  further simplifies as,
              ...
              {eq(mtx("matrix", "\\lambda_{1, 1} \\ket{\\vb{e}_1,0}\\bra{\\vb{e}_1,0} & + & \\lambda_{1, 2}\\ket{\\vb{e}_1,0}\\bra{\\vb{e}_2,0}& + &\\lambda_{1, 3}\\ket{\\vb{e}_1,0}\\bra{\\vb{e}_3,0}& + &\\lambda_{1, 4}\\ket{\\vb{e}_1,0}\\bra{\\vb{0},1}",
                ...
                "\\lambda_{4, 4}\\ket{\\vb{0},1}\\bra{\\vb{0},1}"), "generalLambda_1")}
            ...
            <section>
              ...
              With equation  {ref('timeT')}, we arrive at the final functional form of {mt("{\\bf \\Lambda}({\\vb v})")}
              ...
              {eq("{\\bf \\Lambda}({\\vb v})= \\lambda_{1, 1} \\ket{\\vb{e}_1,0}\\bra{\\vb{e}_1,0} + \\lambda_{1, 4}\\ket{\\vb{e}_1,0}\\bra{\\vb{0},1}+ \\ket{\\vb{e}_2,0}\\bra{\\vb{e}_2,0}+ \\ket{\\vb{e}_3,0}\\bra{\\vb{e}_3,0} -\\beta\\frac{v} {c} \\ket{\\vb{0},1}\\bra{\\vb{e}_1,0}" +
                "+\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1} ", "simpleLambda_v1")}
            ...
            <section>
              ...
              {eq("\\bra{({\\vb n},1)}\\ket{{{\\bf \\Lambda}}^T{\\vb M} {{\\bf \\Lambda}}\\cdot({\\vb n} ,1)}=0", "rt1l")}
              for all {mt("\\vb n")} such that  {mt("||\\vb n||=1")}.

              To solve equation  {ref('rt1l')}   we need {mt("{\\vb M} {{\\bf \\Lambda}}")}, which is {mt("{{\\bf \\Lambda}}")} with the time component changed sign,
              ...
              {eq("{\\vb M} {\\bf \\Lambda}({\\vb v})=" +
                ...
                "-\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1}", "simpleLambda_v11")}
              ...
              {eq("{\\bf \\Lambda}({\\vb v})^T=" +
                ...
                "+\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1} ", "simpleLambda_v12")}
              ...
              {eq(mtx("matrix",
                ...
                "+(\\lambda_{1, 4}^2-\\beta^2) \\ket{\\vb{0},1}\\bra{\\vb{0},1} "), "simpleLambda_v13")}

              and equation {ref('rt1l')}  reads,

              {eq("(\\lambda_{1, 1}^2-\\beta^2\\frac{v ^ 2} {c ^ 2}) n_1^2 + 2(\\lambda_{1, 1}\\lambda_{1, 4}+\\beta^2\\frac{v} {c})n_1+n_2^2 +n_3^2+(\\lambda_{1, 4}^2-\\beta^2) =0", "simpleLambda_v13l")}
              ...
              {gt("(\\lambda_{1, 1}^2-\\beta^2\\frac{v ^ 2} {c ^ 2})   + 2(\\lambda_{1, 1}\\lambda_{1, 4}+\\beta^2\\frac{v} {c}) +(\\lambda_{1, 4}^2-\\beta^2) =0 \\ " +
              ...
              {eq("{\\bf \\Lambda}({\\vb v})= " +
                ...
                "-\\beta\\frac{v} {c} \\ket{\\vb{0},1}\\bra{\\vb{e}_1,0} " +
                "+\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1}", "lambda_1")}
              ...
              {eq("{\\bf \\Lambda}^{-1}({\\vb v})= \\Lambda(-{\\vb v})= " +
                ...
                "\\ket{\\vb{e}_2,0}\\bra{\\vb{e}_2,0}+\\ket{\\vb{e}_3,0}\\bra{\\vb{e}_3,0}" +
                "+\\beta\\frac{v} {c} \\ket{\\vb{0},1}\\bra{\\vb{e}_1,0}" +
                "+\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1} ", "lambda_inv")}
              ...
              {eq("{\\bf \\Lambda}({\\vb v})=" +
                ...
                "+\\beta \\ket{\\vb{0},1}\\bra{\\vb{0},1} \\ ", "lambda_123")}
              ...
              Finally, from equation {ref('simpleLambda_v13l')}, the Lorentz transformation satisfies the condition {mt("{{\\bf \\Lambda}}^T{\\vb M} {{\\bf \\Lambda}}=\\vb M")}, hence {mt("\\Delta' s=\\Delta s")} for all events, not only those on a world line of a photon,

              {eq("\\Delta s'^2 =   \\braket{\\vb  X' | \\vb M  \\vb  X'}= \\braket{{{\\bf \\Lambda}}\\vb{X}| {\\vb M} {{\\bf \\Lambda}}\\vb{X}}=\\braket{\\vb{X} |{{\\bf \\Lambda}}^T{\\vb M} {{\\bf \\Lambda}}\\vb{X}}=\\braket{\\vb{X}| {\\vb M} \\vb{X}}=\\Delta s", "nrm")}
