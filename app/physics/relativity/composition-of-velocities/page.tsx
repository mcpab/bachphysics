...
export default async function Page() {
    ...
    let sections = new Section('Composition of Velocities');

    let comp = sections.addSection('Derivation of Composition of Velocities');
    comp.setContent(<>
    ...
    let limits = sections.addSection('Limit Formulas');

    limits.setContent(<>  In this section we are going to derive the limit formulas for the composition of velocities when one of the velocities approache the speed of light.
    ...
    limits.addSection(<>{mt("\\ket{{\\vb u}}")} Approaching Speed of Light</>).setContent(<>
    ...
    limits.addSection(<>{mt("\\ket{{\\vb v}}")} Approaching Speed of Light</>).setContent(<>
