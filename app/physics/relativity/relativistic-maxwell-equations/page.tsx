    ...
    return (
        ...
        <Stack spacing={24} className=" items-center space-y-6">
            ...
            <MathSection title='Introduction' id='introduction'>
                ...
                <h2>Definitions and Useful Formulas from Multivariate Calculus</h2>

                We will consider a stationary system of reference where the coordinates of an event are represented by the four-vector {mt("x_1,x_2,x_3,t")}, and a moving frame where the same event has coordinates {mt("x'_1,x'_2,x'_3,t'")}.
            ...
            <MathSection title='Transformation of Differential Operators'>
                ...
                <h3>Divergence in {mt("F")} and {mt("F'")}</h3>
            ...
            <MathSection title='The Relativistic Maxwell Equations'>
                ...
                <Divider className='text-sm'> Step 1: Divergence Free Fields </Divider>
                ...
                <Divider className='text-sm'> Step 2: the Curl of the Triple Product </Divider>
